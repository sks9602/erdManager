class  ErdDrawFunction{
    ...
    static drawErdPage(subjectAreaDatas, idxSa, drawDataLoad) {
        ...
        console.log( subjectAreaInfo )
        console.log( idxSa )
        console.log( drawDataLoad )
        console.log( erdSujects )
        erdSujects.add({
            ...
            cls : 'SUBJAREA',
            html : "<div class='minimap' id='minimap-"+subjectAreaInfo["SUBJECT_ID"]+"' style='top:"+(viewSize.height-83-50-15)+"px;left:"+ (Ext.getCmp('LEFT-PANEL').getWidth()+25) +"px'></div>",
            listeners : {
