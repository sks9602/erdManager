         ...
         {  xtype : 'panel',
            ...
            items : [
                {   xtype : 'gridpanel',
                    ...
                    id : 'centerRightViewColumn_gridpanel',
                    selModel: {
                        checkOnly: false,
                        injectCheckbox: 0,
                        mode: 'MULTI'
                    ...
                    // scrollable:true,
                    title: '뷰 컬럼',
                    <tagErd:store type="store" id="viewColumnListStore" idProperty="COLMN_ID" url="/entity/data/columnList.do" rootProperty="data" expanded="false" params="PROJECT_ID : 'PROJECT', ENTITY_ID : ''" autoLoad="true">
                    ...
                    tbar : ['->',
                        <tagErd:button type="button" label="리로드" iconCls="search" cls="btn_segmentedbutton">
                            listeners : {
                                click : function(_this, e, eOpts) { 
                                    var store = Ext.getStore("viewColumnListStore");
                                    store.reload();
                                }
                            }
                        </tagErd:button>
                        <tagErd:button type="splitbutton" label="컬럼 추가" iconCls="search" cls="btn_segmentedbutton" id="btn_viewColumnAdd">
                            disabled : false ,
                            listeners : {
                                click : function(_this, e, eOpts) { 
                                    ...
                                    */
                                    ...
                                    var grid = Ext.getCmp("centerRightViewColumn_gridpanel");
                            ...
                            menu: {
                                plain: true,
                                items: [ 
                                        {text: '3건 추가', id : 'erdCenterRightViewColumn_addColumn3',
                                            disabled : false ,
                                            handler : function(_this, ev) {
                                                 // console.log( Ext.getCmp("centerRightViewColumn_gridpanel").getSelection() );
                                                 var grid = Ext.getCmp("centerRightViewColumn_gridpanel");
                                                 var selectedRecord = grid.getSelectionModel().getSelection()[0];
                                                 var row = grid.store.indexOf(selectedRecord);
                                        ...
                                        {text: '5건 추가', id : 'erdCenterRightViewColumn_addColumn5',
                                            disabled : false ,
                                            handler : function(_this, ev) {
                                                 var grid = Ext.getCmp("centerRightViewColumn_gridpanel");
                                                 var selectedRecord = grid.getSelectionModel().getSelection()[0];
                                        ...
                                        {text: '10건 추가', id : 'erdCenterRightViewColumn_addColumn10',
                                            disabled : false ,
                                            handler : function(_this, ev) {
                                                 var grid = Ext.getCmp("centerRightViewColumn_gridpanel");
                                                 var selectedRecord = grid.getSelectionModel().getSelection()[0];
                                        ...
                                        {text: '다건 추가', id : 'erdCenterRightViewColumn_addColumnMulti',
                                            disabled : false ,
                                            handler : function(_this, ev) {
                                                /*
                                        ...
                                        {text: '공통컬럼 추가', id : 'erdCenterRightViewColumn_addColumnCommon',
                                            disabled : false ,
                                            handler : function(_this, ev) {
                                                 var store = Ext.getStore("viewColumnListStore");
                                                 var entity_id = Ext.getCmp('CENTER_RIGHT_TABLE_ENTITY_ID').getValue();
                        ...
                        <tagErd:button type="splitbutton" label="컬럼 삭제" iconCls="search" cls="btn_segmentedbutton"  id="btn_viewColumnDelete">
                            disabled : false ,
                            listeners : {
                                click : function(_this, e, eOpts) { 
                                    var grid = Ext.getCmp("centerRightViewColumn_gridpanel");
                            ...
                            menu: {
                                ...
                                plain: true,
                                items: [ 
                                        {text: '삭제 취소', id : 'erdCenterRightViewColumn_cancelDeleteColumn',
                                            handler : function(_this, ev) {
                                                var grid = Ext.getCmp("centerRightViewColumn_gridpanel");
                                                var selectedRecords = grid.getSelectionModel().getSelection();
                        ...
                        <tagErd:button type="button" label="글자색 변경" iconCls="search" cls="btn_segmentedbutton" id="btn_viewColumnChangeColor">
                            disabled : false ,
                            listeners : {
                                click : function(_this, e, eOpts) { 
                        ...
                        <tagErd:button type="none" label="사전 적용" iconCls="search" cls="btn_segmentedbutton"  id="btn_viewColumnApplyWord">
                        
                            disabled : false ,
                            /*
                            listeners : {
                                click : function(_this, e, eOpts) { 
                                    var gridColumn = Ext.getCmp("centerRightViewColumn_gridpanel");
                        ...
                        <tagErd:button type="button" label="저장" iconCls="search" cls="btn_segmentedbutton"  id="btn_viewColumnSave">
                            disabled : false ,
                            listeners : {
                                click : function(_this, e, eOpts) { 
                                
                                    submitFormGrid('viewClauseForm', 'centerRightViewColumn_gridpanel',  '/entity/data/columnSave.do',  'all'
                                        , function() { // successFn
                    ...
                    columns: [
                        { xtype: 'rownumberer', },
                        { text: 'SUB-QUERY',  header: '<div style="text-align:center;width:100%;"><div class="grid-header-textfield"></div>SUB-QUERY</div>',dataIndex: 'NUMB_MTH', width : 220, visible : false, align : 'left', locked : true,  sort : false,
                            ...
                            editor: {
                                ...
                                listeners : {
                                    ...
                                    //change : function( _this, newValue, oldValue, eOpts ) {   
                                        var record = Ext.getCmp("centerRightViewColumn_gridpanel").getSelectionModel().getLastSelected();
                ...
                },
                {
                    ...
                    height : 300,
                    maxHeight : 500,
                    title : 'SUB-QUERY/FROM/WHERE 절',
                    style : {padding : "0 0 5 0"},
                    // xtype : 'textarea_ux',
                    xtype : 'formPanel_ux',
                    id : 'viewClauseForm',
                    items : [
                          <tagErd:itemText type="textarea" label="SUB-QUERY/<br>FROM/WHERE 절" id="VIEW_CLAUSE" name="VIEW_CLAUSE" rowspan="13" width="1100" style="'font-family': 'Nanum Gothic Coding', 'font-size':13"></tagErd:itemText>
                          <tagErd:itemText type="hiddenfield" label="ENTITY" id="CENTER_RIGHT_VIEW_ENTITY_ID" name="VIEW_ENTITY_ID" value=""></tagErd:itemText>
                    ]
                },
            ]
        }, 