                ...
                items: [
                    {
                        ...
                        items : [
                            ...
                            {   xtype : 'treepanel',
                                ...
                                rootVisible: false,
                                multiSelect: true,
                                <tagErd:store type="treestore" id="tableLayoutStore" idProperty="ENTITY_ID" url="/entity/data/entityColumnTree.do" rootProperty="CHILDREN" expanded="false" params="PROJECT_ID : 'PROJECT'">
                                      // fields: store.tag로 이동
                                </tagErd:store>
                                columns: [
