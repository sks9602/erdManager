      ...
      value: function drag(ev) {
		...
		*/
		...
		if( this.relationInfo && this.StartOrEnd != "") {
			...
			tableGrp = SVG(".table_"+this.relationInfo["SUBJECT_ID"]+"_"+this.relationInfo[this.StartOrEnd+"_ENTITY_ID"]);
			tableRect = SVG(".rect_"+this.relationInfo["SUBJECT_ID"]+"_"+this.relationInfo[this.StartOrEnd+"_ENTITY_ID"]);
